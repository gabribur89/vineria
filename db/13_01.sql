...
CREATE TABLE stock (
    ...
    codice_stock   INT NOT NULL UNIQUE,
    id_stock       INT NOT NULL UNIQUE,
PRIMARY KEY (id_stock)) TYPE=INNODB;
...
# categoriaprodotto :  
# id_stock        :  (references stock.id_stock)
...
CONSTRAINT fk_prodotto FOREIGN KEY (nomecantina)
    ...
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
    INDEX idx_fk_prodotto2 (id_stock),
CONSTRAINT fk_prodotto2 FOREIGN KEY (id_stock)
